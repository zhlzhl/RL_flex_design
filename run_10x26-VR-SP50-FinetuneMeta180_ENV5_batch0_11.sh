...
python -m spinup.run_flexibility   \
                                   ...
                                   --seed 110 111 112 113 114 115 116 117   \
                                   --save_freq 10    \
                                   ...
                                   --early_stop 40  \
                                   --finetune  \
                                   --finetune_model_path /home/user/git/RL_flex_design/data/10x26_MAML/F10x26-VR-SP20-META_CH1640-332_ENV5_tar0/F10x26-VR-SP20-META_CH1640-332_ENV5_tar0_s110/simple_save180  \
                                   --gamma 0.99   \
                                   --lam 0.999;